...
import Spline360 from "./components/Spline360";
  ...
  return (
    ...
    <Wrapper className="App">
      ...
      <ContentWrapper>
        <Container>
          <TextContainer>
            <Title>Virtual Tour of TACT, Bhubaneshwar.</Title>
            <Description>
              This section contains description and about college. 
            </Description>
          </TextContainer>
          <ButtonContainer>
            <a href="https://tat.ac.in/" target="_blank" rel="noreferrer">
              <WebsiteButton />
            </a>
        ...
        <SplineContainer isOpen={isOpen}>
          ...
          <Routes>
            ...
            <Route path="/spline360" element={<Spline360 />} />
          </Routes>
